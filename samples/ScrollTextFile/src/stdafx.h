...
===============================================================================*
    ...
    Contents Description: Standard Declarations File. This file is used for 
    precompiled headers. Rarely modified header files should beincluded.  Based 
    on code provided by Lynn Allan to Win32++ sample projects, Copyright (c) 
