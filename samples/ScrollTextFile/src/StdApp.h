/* (15-Nov-2016) [Tab/Indent: 4/4][Line/Box: 80/74]                 (StdApp.h) *
********************************************************************************
|                                                                              |
...
===============================================================================*
    ...
    Contents Description: Standard declarations file for this application. This 
    file declares all the pertinent header files belonging to the ScrollWin demo 
